...
Delegation:
- Any multi-step, analytical, or question-answering task can use delegate_task to hand off to Claude. Use it when the user explicitly asks to involve Claude, or when the task benefits from deeper reasoning.
